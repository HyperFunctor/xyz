export function Navigation() {
	return (
		<nav className="mt-5">
			<a
				href="#"
				className="duration-350 mb-8 flex items-center justify-center text-rose-400 transition ease-in-out xl:justify-start"
			>
			...
			<a
				href="#"
				className="duration-350 mb-8 flex items-center justify-center text-gray-800 transition ease-in-out hover:text-rose-400 dark:text-white dark:hover:text-rose-400 xl:justify-start"
			>
				<svg fill="currentColor" viewBox="0 0 24 24" className="h-6 w-6">
					<path
						strokeLinecap="round"
				...
				<span className="text-md ml-4 hidden font-bold xl:block">Explore</span>
			</a>
			...
			>
				...
				<span className="text-md ml-4 hidden font-bold xl:block">Notifications</span>
			</a>
			...
			>
				...
				<span className="text-md ml-4 hidden font-bold xl:block">Messages</span>
			</a>
			...
			>
				...
				<span className="text-md ml-4 hidden font-bold xl:block">Bookmarks</span>
			</a>
			...
			>
				...
				<span className="text-md ml-4 hidden font-bold xl:block">Lists</span>
			</a>
			...
			>
				...
				<span className="text-md ml-4 hidden font-bold xl:block">Profile</span>
			</a>
			...
			<a
				href="#"
				className="font-sm duration-350 mx-auto mb-10 flex h-11 w-11 items-center justify-center rounded-full bg-rose-400 py-3 font-bold text-white transition ease-in-out hover:bg-rose-500 xl:w-auto"
			>
				...
				<span className="text-md hidden font-bold xl:block">Post</span>
			</a>
		</nav>
	);
}
